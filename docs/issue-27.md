...
> #28 Phase 2에서 그룹 간 단일 전체 검정, SRM, 설정 잠금을 추가했습니다. 아래는 #27 시점의 결정이며 현재 정책은 [Phase 2 문서](issue-28-phase-2.md)를 확인하세요.

이 문서는 #27 당시의 원격 SDK 동작과 검증 기록입니다. SDK 기본 로컬 평가 모드와 추가 스키마 변경은 [#28 Phase 1](issue-28-phase-1.md)을 함께 확인하세요.
